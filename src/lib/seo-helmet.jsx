  ...
  switch (page) {
      ...
      return [
        {
          ...
          description: 'Coach vocal IA pour analyser les prix en temps réel et négocier équitablement comme un local au Maroc.',
          foundingDate: '2023',
    ...
    case 'alerts':
      return [{
        ...
        url: `${BASE}/alerts`,
        description: 'Conseils pratiques pour voyager sereinement au Maroc : taxis avec compteur, guides officiels, prix affichés dans les restaurants, change dans les banques.',
        mainEntity: {
          '@type': 'ItemList',
          name: 'Conseils de vigilance pour touristes au Maroc',
          itemListElement: [
