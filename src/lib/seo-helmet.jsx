...
const ORG = {
  ...
  description: 'Tooristoo créé en 2026 pour aider les touristes à connaître les prix réels au Maroc et négocier équitablement via un coach IA vocal négociateur multilingue.',
  foundingDate: '2026',
        ...
        return [
          {
            ...
            '@type': 'FAQPage',
            '@id': `${BASE}/faq`,
            name: 'FAQ Tooristoo — Questions fréquentes sur le coach IA négociateur Maroc',
            url: `${BASE}/faq`,
            publisher: { '@id': `${BASE}/#organization` },
            mainEntity: [
              { '@type': 'Question', name: 'Qu\'est-ce que Tooristoo ?', acceptedAnswer: { '@type': 'Answer', text: 'Tooristoo est un coach vocal IA négociateur qui aide les touristes à négocier les meilleurs prix au Maroc et obtenir des phrases de négociation en darija en temps réel. Disponible gratuitement sur web, iOS et Android.' } },
              { '@type': 'Question', name: 'Est-ce que Tooristoo est gratuit ?', acceptedAnswer: { '@type': 'Answer', text: 'Oui, Tooristoo propose un plan gratuit avec 3 analyses par jour sans carte de crédit. Les plans Voyageur (5€/mois) et Pro (12€/mois) offrent 50 à 100 analyses par mois.' } },
      ...
      return [
        {
          ...
          url: `${BASE}/about`,
          description: 'Tooristoo est une startup franco-marocaine fondée en 2026 pour aider les touristes à connaître les prix réels au Maroc et voyager en toute sérénité.',
          publisher: { '@id': `${BASE}/#organization` },
          mainEntity: {
            '@context': 'https://schema.org',
            ...ORG,
            founder: [
              { '@type': 'Person', name: 'Azeddine Maghraoui', jobTitle: 'CEO & Fondateur', description: 'Créateur de Tooristoo.' },
            ],
      ...
      return [
        {
          ...
          mainEntity: {
            ...
            itemListElement: [
              ...
              { '@type': 'ListItem', position: 4, name: 'Note minimale 4.0/5 — contrôle qualité continu' },
