export const dashboardTranslations = {
  fr: {
    ...
    price_above_market_label: "Prix au-dessus du marché",
    recommended_strategy: "STRATÉGIE RECOMMANDÉE",
    exact_phrase: "PHRASE EXACTE À DIRE",
    potential_savings_label: "ÉCONOMIE POTENTIELLE",
  ...
  en: {
    ...
    price_above_market_label: "Price above market",
    ...
    estimation_transaction: "Estimation on this transaction",
    ask_price: "Price asked:",
  ...
  es: {
    ...
    price_above_market_label: "Precio por encima del mercado",
    recommended_strategy: "ESTRATEGIA RECOMENDADA",
    exact_phrase: "FRASE EXACTA PARA DECIR",
    ...
    ask_price: "Precio pedido:",
    category_label: "Categoría:",
    situation_label: "Situación",
  },
  de: {
    ...
    price_above_market_label: "Preis über dem Markt",
    recommended_strategy: "EMPFOHLENE STRATEGIE",
    exact_phrase: "GENAUE AUSSAGE ZUM SAGEN",
    potential_savings_label: "MÖGLICHE EINSPARUNGEN",
    community_reports: "GEMEINSCHAFTSBERICHTE",
    estimation_transaction: "Schätzung bei dieser Transaktion",
    ask_price: "Geforderter Preis:",
  ...
  ar: {
    ...
    anomaly_detected: "تم كشف شذوذ",
    price_above_market_label: "السعر أعلى من السوق",
    recommended_strategy: "الاستراتيجية الموصى بها",
    exact_phrase: "العبارة الدقيقة للقول",
    potential_savings_label: "التوفير المحتمل",
    community_reports: "التقارير المجتمعية",
    estimation_transaction: "التقدير على هذه العملية",
    ask_price: "السعر المطلوب:",
    category_label: "الفئة:",
    situation_label: "الحالة",
  },
  darija: {
    ai_coach: "الذكاء الاصطناعي",
    ...
    price_above_market_label: "الثمن فوق السوق",
    recommended_strategy: "الاستراتيجية المنصوح بها",
    exact_phrase: "الجملة الدقيقة باش تقول",
    potential_savings_label: "التوفير المحتمل",
    community_reports: "البلاغات المجتمعية",
    estimation_transaction: "التقدير على هاد العملية",
    ask_price: "الثمن المطلوب:",
    category_label: "الفئة:",
