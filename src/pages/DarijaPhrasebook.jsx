...
const UI = {
  fr: { title: '100 Phrases en Darija', subtitle: 'Le vocabulaire essentiel pour voyager au Maroc sans se faire arnaquer — avec transcription latine et traduction', search: 'Rechercher une phrase…', copy: 'Copié !', tip: '💡 Astuce : La phrase n°44 "Le prix Tooristoo dit..." est particulièrement efficace pour négocier !', cta_title: 'Négociez avec l\'IA en temps réel', cta_btn: 'Essayer le Coach IA' },
  en: { title: '100 Darija Phrases', subtitle: 'Essential vocabulary to travel Morocco without getting scammed — with Latin transcription and translation', search: 'Search a phrase…', copy: 'Copied!', tip: '💡 Tip: Phrase #44 "The Tooristoo price says..." is especially effective for negotiating!', cta_title: 'Negotiate with AI in real time', cta_btn: 'Try the AI Coach' },
  es: { title: '100 Frases en Darija', subtitle: 'El vocabulario esencial para viajar por Marruecos sin ser estafado — con transcripción latina y traducción', search: 'Buscar una frase…', copy: '¡Copiado!', tip: '💡 Consejo: La frase #44 "El precio de Tooristoo dice..." es especialmente efectiva para negociar!', cta_title: 'Negocia con IA en tiempo real', cta_btn: 'Probar el Coach IA' },
  de: { title: '100 Darija-Phrasen', subtitle: 'Grundvokabular für Reisen in Marokko ohne betrogen zu werden — mit lateinischer Transkription und Übersetzung', search: 'Phrase suchen…', copy: 'Kopiert!', tip: '💡 Tipp: Phrase #44 "Der Tooristoo-Preis sagt..." ist besonders effektiv beim Verhandeln!', cta_title: 'Mit KI in Echtzeit verhandeln', cta_btn: 'KI-Coach ausprobieren' },
  ar: { title: '100 عبارة بالدارجة', subtitle: 'المفردات الأساسية للسفر في المغرب دون أن تُخدع — مع النسخ اللاتيني والترجمة', search: 'ابحث عن عبارة…', copy: 'تم النسخ!', tip: '💡 نصيحة: العبارة رقم 44 "سعر Tooristoo يقول..." فعالة جداً في التفاوض!', cta_title: 'تفاوض مع الذكاء الاصطناعي في الوقت الفعلي', cta_btn: 'جرب المدرب الذكي' },
};
