...
const PHRASES = [
  ...
  { id: 33, cat: 'negotiation', darija: 'شفت هاد الشي بثمن أقل عند جيراني', latin: 'Shaft had shi b-taman aqal 3and jiranik', fr: 'J\'ai vu ça moins cher chez les voisins', en: 'I saw this cheaper next door', es: 'Vi esto más barato en el local de al lado', de: 'Ich habe das woanders günstiger gesehen' },
...
const UI = {
  fr: { title: '50 Phrases en Darija', subtitle: 'Le vocabulaire essentiel pour négocier au Maroc comme un local — avec transcription latine et traduction', search: 'Rechercher une phrase…', copy: 'Copié !', tip: '💡 Astuce : La phrase n°44 "Le prix Tooristoo dit..." est particulièrement efficace pour négocier !', cta_title: 'Négociez avec l\'IA en temps réel', cta_btn: 'Essayer le Coach IA' },
  ...
  es: { title: '50 Frases en Darija', subtitle: 'El vocabulario esencial para viajar por Marruecos sin negociar como un local — con transcripción latina y traducción', search: 'Buscar una frase…', copy: '¡Copiado!', tip: '💡 Consejo: La frase #44 "El precio de Tooristoo dice..." es especialmente efectiva para negociar!', cta_title: 'Negocia con IA en tiempo real', cta_btn: 'Probar el Coach IA' },
  de: { title: '50 Darija-Phrasen', subtitle: 'Grundvokabular für Reisen in Marokko wie ein Einheimischer zu verhandeln — mit lateinischer Transkription und Übersetzung', search: 'Phrase suchen…', copy: 'Kopiert!', tip: '💡 Tipp: Phrase #44 "Der Tooristoo-Preis sagt..." ist besonders effektiv beim Verhandeln!', cta_title: 'Mit KI in Echtzeit verhandeln', cta_btn: 'KI-Coach ausprobieren' },
