...
const PHRASES = [
  ...
  { id: 9,  cat: 'taxi',       darija: 'دور العداد عافاك',                  latin: 'Douwour l-3adad 3afak',                 fr: 'Mettez le compteur s\'il vous plaît',      en: 'Turn on the meter please',           es: 'Pon el taxímetro por favor',          de: 'Schalten Sie das Taxameter ein bitte' },
  ...
  { id: 12, cat: 'taxi',       darija: 'كيفاش نوصل ل...؟',                  latin: 'Kifash nwassal l...?',                  fr: 'Comment aller à... ?',                     en: 'How do I get to...?',                es: '¿Cómo llego a...?',                   de: 'Wie komme ich zu...?' },
  { id: 13, cat: 'taxi',       darija: 'الثمن ديال الطاكسي للمطار كم هو؟',  latin: 'Bshhal taman taxi l-matar?',            fr: 'Quel est le tarif taxi pour l\'aéroport ?',en: 'What is the taxi fare to the airport?',es: '¿Cuánto cuesta el taxi al aeropuerto?',de: 'Was kostet das Taxi zum Flughafen?' },
  ...
  { id: 19, cat: 'market',     darija: 'غير كنشوف، ماشي شاري دابا',         latin: 'Ghir kanchouf, mashi shari daba',       fr: 'Je regarde juste, je n\'achète pas maintenant', en: 'Just looking, not buying now',  es: 'Solo mirando, no compro ahora',       de: 'Ich schaue nur, kaufe jetzt nicht' },
  ...
  { id: 21, cat: 'restaurant', darija: 'فين المينو عافاك؟',                 latin: 'Fin l-menu 3afak?',                     fr: 'Le menu s\'il vous plaît ?',               en: 'The menu please?',                   es: '¿El menú por favor?',                 de: 'Die Speisekarte bitte?' },
  ...
  { id: 33, cat: 'negotiation',darija: 'شفت هاد الشي بثمن أقل عند جيراني', latin: 'Shaft had shi b-taman aqal 3and jirani',fr: 'J\'ai vu ça moins cher chez les voisins',  en: 'I saw this cheaper next door',       es: 'Vi esto más barato en el local de al lado',de: 'Ich habe das woanders günstiger gesehen' },
  ...
  { id: 47, cat: 'market',     darija: 'بغيت نقارن الأثمان أولاً',          latin: 'Bghit nqaren l-taman awalan',           fr: 'Je veux comparer les prix d\'abord',       en: 'I want to compare prices first',     es: 'Quiero comparar precios primero',     de: 'Ich möchte zuerst Preise vergleichen' },
...
const UI = {
  fr: { title: '50 Phrases en Darija', subtitle: 'Le vocabulaire essentiel pour négocier au Maroc comme un local — avec transcription latine et traduction', search: 'Rechercher une phrase…', tip: '💡 Astuce : La phrase n°44 "Le prix Tooristoo dit..." est particulièrement efficace pour négocier !', cta_title: 'Négociez avec l\'IA en temps réel', cta_btn: 'Essayer le Coach IA' },
  en: { title: '50 Darija Phrases',    subtitle: 'Essential vocabulary to negotiate in Morocco like a local — with Latin transcription and translation',          search: 'Search a phrase…',        tip: '💡 Tip: Phrase #44 "The Tooristoo price says..." is especially effective for negotiating!',          cta_title: 'Negotiate with AI in real time',      cta_btn: 'Try the AI Coach' },
  es: { title: '50 Frases en Darija',  subtitle: 'El vocabulario esencial para negociar en Marruecos como un local — con transcripción latina y traducción',      search: 'Buscar una frase…',       tip: '💡 Consejo: La frase #44 "El precio de Tooristoo dice..." es especialmente efectiva para negociar!', cta_title: 'Negocia con IA en tiempo real',        cta_btn: 'Probar el Coach IA' },
  de: { title: '50 Darija-Phrasen',    subtitle: 'Grundvokabular um in Marokko wie ein Einheimischer zu verhandeln — mit lateinischer Transkription',             search: 'Phrase suchen…',          tip: '💡 Tipp: Phrase #44 "Der Tooristoo-Preis sagt..." ist besonders effektiv beim Verhandeln!',          cta_title: 'Mit KI in Echtzeit verhandeln',        cta_btn: 'KI-Coach ausprobieren' },
  ar: { title: '50 عبارة بالدارجة',   subtitle: 'المفردات الأساسية للسفر في المغرب دون أن تُخدع — مع النسخ اللاتيني والترجمة',                                  search: 'ابحث عن عبارة…',          tip: '💡 نصيحة: العبارة رقم 44 "سعر Tooristoo يقول..." فعالة جداً في التفاوض!',                           cta_title: 'تفاوض مع الذكاء الاصطناعي',           cta_btn: 'جرب المدرب الذكي' },
};
...
const SCHEMA = {
  ...
  description: 'Guide complet de 50 phrases essentielles en darija marocain avec transcription latine et traduction en 5 langues.',
  url: `${BASE}/darija`,
  ...
  return (
    <div className="min-h-screen bg-shield-dark">
      <Helmet>
        ...
        <meta name="description" content="50 phrases essentielles en darija marocain avec transcription latine et traduction FR/EN/ES/DE/AR. Taxi, souk, restaurant, hôtel, négociation, urgences." />
        <meta property="og:title"       content="50 Phrases en Darija Marocain pour Voyager au Maroc | Tooristoo" />
        <meta property="og:description" content="Le guide de référence des phrases en darija pour touristes. Transcription latine + 5 traductions." />
      ...
      <div className="max-w-4xl mx-auto px-4 pt-28 pb-20">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-poppins font-black text-4xl md:text-5xl text-white mb-4">{ui.title}</h1>
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  {/* Bouton Audio */}
                  <VoiceButton darija={phrase.darija} />

                  {/* Bouton Copier */}
                  <button
                    onClick={() => handleCopy(`${phrase.darija} — ${phrase.latin} — ${getTranslation(phrase)}`, phrase.id)}
                    className="p-2 rounded-lg bg-shield-border/50 hover:bg-shield-border text-gray-400 hover:text-white transition-all opacity-60 hover:opacity-100"
                    title="Copier"
                  >
                    {copied === phrase.id
