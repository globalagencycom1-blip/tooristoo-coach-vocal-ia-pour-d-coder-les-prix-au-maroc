...
const CONTENT = {
  fr: {
    ...
    commitments: [
      ...
      { icon: '🤝', title: 'Engagement anti-discrimination', desc: 'Le même service, le même prix, le même accueil pour tous les clients — locaux ou étrangers, quelle que soit la nationalité ou la langue.' },
      { icon: '🚨', title: 'Signalement traité', desc: 'En cas de signalement d\'arnaque validé par 3 utilisateurs, le prestataire est suspendu dans les 24h le temps d\'investigation.' },
    ],
    ...
    why: [
      { title: 'Zéro arnaque garantie', desc: 'Avec un prestataire certifié, vous avez un contrat moral basé sur des prix transparents.' },
      { title: 'Recours en cas de problème', desc: 'Si un prestataire certifié vous arnaque, signalez-le — nous agissons sous 24h.' },
      { title: 'Soutenir l\'économie locale éthique', desc: 'Nos partenaires certifiés sont des acteurs locaux qui jouent le jeu de la transparence.' },
    ],
  ...
  en: {
    ...
    commitments: [
      ...
      { icon: '🤝', title: 'Anti-discrimination commitment', desc: 'The same service, the same price, the same welcome for all customers — locals or foreigners, regardless of nationality or language.' },
      { icon: '🚨', title: 'Reports handled', desc: 'If a scam report is validated by 3 users, the provider is suspended within 24 hours pending investigation.' },
    ],
    ...
    why: [
      { title: 'Zero scam guarantee', desc: 'With a certified provider, you have a moral contract based on transparent pricing.' },
      { title: 'Recourse if problems arise', desc: 'If a certified provider scams you, report it — we act within 24 hours.' },
      { title: 'Support ethical local economy', desc: 'Our certified partners are local actors committed to transparency.' },
    ],
  ...
  es: {
    ...
    commitments: [
      ...
      { icon: '🤝', title: 'Compromiso anti-discriminación', desc: 'El mismo servicio, el mismo precio para todos los clientes.' },
      { icon: '🚨', title: 'Denuncias tramitadas', desc: 'Suspensión en 24h si una denuncia es validada por 3 usuarios.' },
    ],
    ...
    why: [
      { title: 'Cero estafa garantizada', desc: 'Con un proveedor certificado tienes un contrato moral de precio transparente.' },
      { title: 'Recurso en caso de problema', desc: 'Si un certificado te estafa, denúncialo — actuamos en 24h.' },
      { title: 'Apoya la economía local ética', desc: 'Nuestros socios son actores locales comprometidos con la transparencia.' },
    ],
