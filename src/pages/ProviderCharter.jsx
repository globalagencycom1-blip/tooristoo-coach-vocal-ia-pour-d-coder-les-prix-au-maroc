...
const CONTENT = {
  fr: {
    ...
    commitments: [
      ...
      { icon: '✅', title: 'Vérification terrain', desc: 'Un membre de l\'équipe Tooristoo a recherché et sélectionné le service en ligne. Ré-évaluation mensuelle obligatoire.' },
