      ...
      <div className="max-w-4xl mx-auto px-4 pt-24 pb-12">
        ...
        <div className="bg-shield-card border border-shield-border rounded-2xl p-8 space-y-6 text-gray-300 text-sm leading-relaxed">
          <section>
            ...
            <p>{lang === 'fr' ? 'En utilisant NegoShield AI, vous acceptez ces conditions d\'utilisation. Si vous n\'êtes pas d\'accord avec l\'une de ces conditions, veuillez ne pas utiliser l\'application.' : lang === 'en' ? 'By using NegoShield AI, you accept these terms of use. If you do not agree with any of these terms, please do not use the application.' : lang === 'es' ? 'Al usar NegoShield AI, acepta estos términos de uso. Si no está de acuerdo con alguno de estos términos, no use la aplicación.' : lang === 'de' ? 'Durch die Nutzung von NegoShield AI akzeptieren Sie diese Nutzungsbedingungen. Wenn Sie diesen Bedingungen nicht zustimmen, verwenden Sie die Anwendung nicht.' : lang === 'ar' ? 'باستخدام NegoShield AI، تقبل هذه الشروط. إذا كنت لا توافق على أي من هذه الشروط، يرجى عدم استخدام التطبيق.' : 'بالاستخدام ديال NegoShield AI، تقبل الشروط ديال. إلا كنت ما توافقش على شي شرط، ما تستخدمش التطبيق.'}</p>
          </section>
          ...
          <section>
            ...
            <p>{lang === 'fr' ? 'Vous acceptez d\'utiliser NegoShield AI uniquement pour des fins légales et conformes à la loi marocaine. Vous ne devez pas utiliser l\'application pour des activités illégales ou nuisibles.' : lang === 'en' ? 'You agree to use NegoShield AI only for legal purposes and in compliance with Moroccan law. You must not use the application for illegal or harmful activities.' : lang === 'es' ? 'Usted acepta usar NegoShield AI solo para fines legales y de conformidad con la ley marroquí. No debe usar la aplicación para actividades ilegales o perjudiciales.' : lang === 'de' ? 'Sie erklären sich damit einverstanden, NegoShield AI nur für legale Zwecke und in Übereinstimmung mit dem marokkanischen Recht zu nutzen. Sie dürfen die Anwendung nicht für illegale oder schädliche Aktivitäten verwenden.' : lang === 'ar' ? 'توافق على استخدام NegoShield AI فقط لأغراض قانونية وامتثالاً للقانون المغربي. يجب عدم استخدام التطبيق للأنشطة غير القانونية أو الضارة.' : 'توافق على استخدام NegoShield AI غير قانوني وتحت التزام بالقانون المغربي. ما تستخدمش التطبيق لنشاطات غير قانونية.'}</p>
          </section>
          ...
          <section>
            ...
            <p>{lang === 'fr' ? 'NegoShield AI fournit des analyses et recommandations basées sur l\'intelligence artificielle. Nous ne garantissons pas que les recommandations seront toujours précises ou conduiront à un résultat spécifique.' : lang === 'en' ? 'NegoShield AI provides analysis and recommendations based on artificial intelligence. We do not guarantee that the recommendations will always be accurate or lead to a specific outcome.' : lang === 'es' ? 'NegoShield AI proporciona análisis y recomendaciones basadas en inteligencia artificial. No garantizamos que las recomendaciones siempre sean precisas o conduzcan a un resultado específico.' : lang === 'de' ? 'NegoShield AI bietet Analysen und Empfehlungen auf Basis künstlicher Intelligenz. Wir garantieren nicht, dass die Empfehlungen immer genau sind oder zu einem bestimmten Ergebnis führen.' : lang === 'ar' ? 'يوفر NegoShield AI تحليلات وتوصيات بناءً على الذكاء الاصطناعي. لا نضمن أن التوصيات ستكون دائماً دقيقة أو تؤدي إلى نتيجة معينة.' : 'يقدم NegoShield AI تحليلات وتوصيات بناء على AI. ما تضمنش أن التوصيات كتكون دقيقة دايما.'}</p>
          </section>
