    ...
    <div className="min-h-screen bg-shield-dark">
      <noscript>
        <article style={{padding:'2rem',fontFamily:'sans-serif'}}>
          <h1>Alertes Abus de Prix au Maroc</h1>
          <p>Liste des abus de prix les plus fréquents signalés par la communauté Tooristoo. Consultez ces alertes avant votre voyage pour visiter le Maroc en toute sécurité.</p>
          <h2>Abus de prix fréquents</h2>
          <ul>
            ...
            <li><strong>Abus de prix dans les souks</strong> — Objets présentés comme "artisanat local" en réalité importés. Comparez les prix dans plusieurs boutiques avant d'acheter.</li>
      ...
      <PageHelmet page="alerts" lang={lang} />
      <Navbar />
