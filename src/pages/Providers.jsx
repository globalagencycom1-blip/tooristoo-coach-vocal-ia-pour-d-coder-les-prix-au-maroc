  ...
  return (
    <div className="min-h-screen bg-shield-dark">
      ...
      <Helmet>
        ...
        <link rel="canonical" href={`${BASE}/providers`} />
        <link rel="alternate" hreflang="fr" href={`${BASE}/providers`} />
        <link rel="alternate" hreflang="en" href={`${BASE}/providers`} />
        <link rel="alternate" hreflang="es" href={`${BASE}/providers`} />
        <link rel="alternate" hreflang="de" href={`${BASE}/providers`} />
        <link rel="alternate" hreflang="ar" href={`${BASE}/providers`} />
        <link rel="alternate" hreflang="x-default" href={`${BASE}/providers`} />
      </Helmet>
      <Navbar />
